            ...
            function _getScore(){
              ...
              if (section==="/konec") {
                  ...
                  var container='<div class="b-w-alert-bg"><p class="b-prompt-msg">Chcete opravdu skončit hru?</p><button class="b-submit b-prompt-bt-left">Ano</button><button class="b-submit b-prompt-bt-right">Ne</button></div>';
